...
const Future = () => {
    return (
        <div className='future'>
            After completing a diploma from Government Polytechnic Hyderabad, individuals have several opportunities available to them, including:
            ...
            <div className='jobs'>
                <h1>2. Jobs:</h1>
                <p>Diploma holders from Government Polytechnic Hyderabad are also eligible to apply for various job opportunities in both the public and private sectors. Some potential job roles for diploma holders include:</p>

                <ul>

                    <li>Junior Engineer (JE) in government departments such as Public Works Department (PWD), Irrigation Department, Electricity Board, etc.</li>
                    <li>Technician positions in manufacturing industries, construction companies, telecommunications companies, etc.</li>
                    <li>Technical support roles in IT companies.</li>
                    <li>Supervisory positions in industries related to their field of specialization.</li>
                    <li>Apprenticeship programs offered by companies for skill development and on-the-job training.</li>
                    <li>Entrepreneurship opportunities: Diploma holders can also consider starting their own businesses in areas such as construction, electronics repair, small-scale manufacturing, etc.</li>

                </ul>
                Overall, completing a diploma from Government Polytechnic Hyderabad equips individuals with technical skills and knowledge that are in demand across various industries. Whether they choose to pursue further education through ECET or enter the workforce directly, diploma holders have a range of opportunities available to them for career advancement and personal growth.
            </div>
        </div>
    )
}
